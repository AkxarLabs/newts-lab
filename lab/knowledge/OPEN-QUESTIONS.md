...
Threads worth pursuing. `/ideate` reads this file first — it is the lab's compounding idea pipeline. Append freely during any procedure; prune during ideation triage.
