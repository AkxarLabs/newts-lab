...
**Tunables:** lab-wide defaults (ensemble sizes, debug depth, seed counts, backoff, staleness) live in `lab/config.yaml` — skills read it; change values there, not in skill files.
